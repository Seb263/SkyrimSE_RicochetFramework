...
-- project infos
local projectName = "RicochetFramework"
...
target(projectName)
	...
	add_rules("commonlibsse-ng.plugin", {
		name = projectName,
		author = "Seb263",
		description = "Ricochet Framework binaries"
	})
    ...
    add_files("extern/Papyrus/RicochetFramework.psc")
    add_files("extern/Papyrus/RicochetFramework.pex")
